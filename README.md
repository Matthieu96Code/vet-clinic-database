...
**[vet-clinic-database]** is a project in which I used a relational database to create the data structure for a vet clinic. I started with one table, and step by step, I created a complete database with data about: animals, animals' owners, clinic employees, visits
...
```sh
  cd my-folder
  git clone https://github.com/Matthieu96Code/vet-clinic-database.git
```
-
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/vet-clinic-database/issues).
